...
class _ApplyLeaveState extends State<ApplyLeave> {
  ...
  Future<void> _fetchApprovers(String employeeId) async {
    try {
      final response = await http.get(
        Uri.parse('https://hrm-project-2.onrender.com/apply/approvers/$employeeId'),
      );
      if (response.statusCode == 200) {
  ...
  void _submitLeave() async {
    ...
    final url = isEditing
        ? 'https://hrm-project-2.onrender.com/apply/update/$employeeId/$leaveId'
        : 'https://hrm-project-2.onrender.com/apply/apply-leave';
